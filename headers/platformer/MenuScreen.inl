...
void MenuScreen::build() {
	...
	background->setResolution(640, 380);
...
void MenuScreen::onEntry() {
	...
	spriteFont = new SpriteFont("assets/fonts/rajdhani.ttf", 40);	
}
...
void MenuScreen::draw() {
	...
	sprintf_s(buffer, "Enzo Alexander Huacacolque Toledo - u201620508  (Profe apruebeme :'v )");
